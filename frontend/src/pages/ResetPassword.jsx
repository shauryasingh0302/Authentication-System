    ...
    <div className='flex items-center justify-center min-h-screen sm:px-0 bg-linear-to-br from-blue-200 to-purple-400'>
        ...
        <form onSubmit={onSubmitEmail} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
          ...
          <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
            ...
            <input
              ...
              className='bg-transparent outline-none text-white flex-1 w-full min-w-0'
            />
          </div>
      ...
      {!isOtpSubmitted && isEmailSent && (
        <form onSubmit={onSubmitOtp} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
          ...
          <button
            type='submit'
            className='w-full py-2.5 bg-linear-to-r from-indigo-500 to-indigo-900 text-white rounded-full'
          >
            Submit
          </button>
        </form>
